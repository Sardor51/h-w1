...
var _name = prompt('Введите своё имя');
console.log('Меня зовут '+ _name);
...
var primer4 = +prompt('Решите пример' +'5*6=?')
console.log('Пример 4: ' + '5*6='+ 5*6 +' Ваш ответ: ' + primer4);
var primer5 = +prompt('Решите пример' +'10%6=?')
console.log('Пример 5: ' + '10%6='+ 10%6 +' Ваш ответ: ' + primer5);